...
const FenceDetailModal = ({ show, handleClose, fence }) => {
  ...
  const whatsappURL =
    ...
    encodeURIComponent(
      `Hola, me gustaría recibir más información sobre sus cercos vibrados.`,
    );
  ...
  return (
    <Modal show={show} onHide={handleClose} centered size="lg">
      ...
      <Modal.Body>
        ...
        <ul>
          <li>
            <strong>Altura:</strong> {fence.height}
          </li>
          <li>
            <strong>Material:</strong> Hormigón vibrado de alta resistencia
          </li>
          <li>
            <strong>Acabado:</strong> Liso o con textura
          </li>
          <li>
            <strong>Uso recomendado:</strong> Residencial, industrial, agrícola
          </li>
        </ul>
      </Modal.Body>
      <Modal.Footer>
